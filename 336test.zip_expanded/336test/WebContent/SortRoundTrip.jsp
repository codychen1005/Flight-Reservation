...
<body
	...
	<h2>
	This is the sorted and filtered table for departure from .
	</h2>
<%
		String flightNumber;
		try {
			...
			//String str = "SELECT o.companyID, a.name, f.departure_time, f.arrival_time, f.departure_airport, f.arrival_airport, f.operating_days, f.total_fare from Flight as f, Airline_Company as a, Operate as o where o.companyID = a.companyID and o.flight_number = f.flight_number and o.companyID = '" + name + "' and total_fare <= " + price + " and f.departure_airport = ('"+ departureAirport + "') and f.arrival_airport =('"+ arrivalAirport + "') and f.operating_days like '%"+ result1.getString("t")+ "%' ORDER BY " +sortFlight;              
			str = "SELECT o.flight_number, a.name, f.departure_time, f.arrival_time, f.departure_airport, f.arrival_airport, f.operating_days, f.total_fare from Flight as f, Airline_Company as a, Operate as o where o.companyID = a.companyID and o.flight_number = f.flight_number and f.departure_airport = ('"+ departureAirport + "') and f.arrival_airport =('"+ arrivalAirport + "') and o.companyID ='" 
						+ name + "' and f.total_fare <=" + price + " and (f.operating_days like '%" + result1.getString("t") + "%' or f.operating_days like '%" + before[0] + "%' or f.operating_days like '%" + before[1] + "%' or f.operating_days like '%" + before[2] + "%' or f.operating_days like '%" + after[0] + "%' or f.operating_days like '%" + after[1] + "%' or f.operating_days like '%" + after[2] + "%') ORDER BY " +sortFlight + ";"; 
			}
			
			else {
				 str = "SELECT o.flight_number, a.name, f.departure_time, f.arrival_time, f.departure_airport, f.arrival_airport, f.operating_days, f.total_fare from Flight as f, Airline_Company as a, Operate as o where o.companyID = a.companyID and o.flight_number = f.flight_number and f.departure_airport = ('"+ departureAirport + "') and f.arrival_airport =('"+ arrivalAirport + "') and f.operating_days like '%"+ result1.getString("t")+ "%' and o.companyID ='" 
						+ name + "' and f.total_fare <=" + price + " ORDER BY " +sortFlight + ";"; 
			}
			...
			<td>
				<form action="reserve.jsp">
					<input type="hidden" name="sortBy"
						...
						<input
						type="hidden" name="arrival_date"
						value="<%=request.getParameter("arrival_date")%>" /> <input
