...
<br>
	...
	<!-- this is user inputs from searchFlight 4 to the RoundTrip2.jsp -->
	<h3>Go to the return flight table please click submit below</h3>
	<form method="post" action="RoundTrip2.jsp">
		<input type="hidden" name="sortBy"
			value="<%=request.getParameter("sortBy")%>" /> <input type="hidden"
			name="flexible_or_not"
			value="<%=request.getParameter("flexible_or_not")%>" /> <input
