...
<body background = "https://allfreedesigns.com/wp-content/uploads/2016/02/lace-background-10.jpg">
	...
	<% //Get the database connection
			...
			String arrivalDate = request.getParameter("departure_date");//request.setAttribute("departureDate", departureDate);
			...
			*/
			...
			out.println(query_ticket);
			
			out.println("Successful!");
			//String query = "insert into Ticket (trip_type, valid_for_change, special_meal, class, date_of_purchase, time_of_purchase, booking_fee) values ('"+tripType+"', '"+change+"', '"+specialMeal+"', '"+flightClass+"', '"+ result.getString("d")+"', '"+result2.getString("t")+"', 30;";                                    
			//out.println(query);
			//Run the query against the database.
	%>
</body>
